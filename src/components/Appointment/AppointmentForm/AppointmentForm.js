...
const AppointmentForm = ({ modalIsOpen, closeModal, appointmentOn, date }) => {
    ...
    const onSubmit = data => {
        ...
        fetch('https://shielded-cove-63328.herokuapp.com/addAppointment', {
            method: 'POST',
    ...
    return (
        <div>
            ...
            >
                ...
                <p className="text-secondary text-center text-success"><small>ON {date.toDateString()}</small></p>
                <button onClick={closeModal} className="btn btn-brand ml-5 ">close</button>
